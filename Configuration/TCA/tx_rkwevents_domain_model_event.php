...
return [
    ...
    'types' => [
        '1' => [
            'showitem' => '
                ...
                'seats, costs_reg, costs_red, costs_red_condition, currency, costs_tax, reg_required, reg_single, online_event, online_event_access_link, ext_reg_link, target_groups, prioritized_target_groups, approval_auto, approval_date, 
    ...
    'columns' => [
        ...
        'target_groups' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rkw_events/Resources/Private/Language/locallang_db.xlf:tx_rkwevents_domain_model_event.target_groups',
            'config' => [
                'type' => 'select',
        ...
        'prioritized_target_groups' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rkw_events/Resources/Private/Language/locallang_db.xlf:tx_rkwevents_domain_model_event.prioritized_target_groups',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_rkwbasics_domain_model_targetgroup',
        ...
        */
        ...
        'approval_auto' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rkw_events/Resources/Private/Language/locallang_db.xlf:tx_rkwevents_domain_model_event.approval_auto',
            'config' => [
                'type' => 'check',
                'default' => 0
            ]
        ...
        'approval_date' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rkw_events/Resources/Private/Language/locallang_db.xlf:tx_rkwevents_domain_model_event.approval_date',
            'config' => [
                'type' => 'input',
                'size' => 13,
                'max' => 20,
